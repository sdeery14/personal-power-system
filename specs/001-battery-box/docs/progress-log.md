...
- **Plywood panel architecture**: Instead of mounting Blue Sea/Victron/displays directly to flexible HDPE tote walls, components mount to 3/4" plywood panels (left side ~12"×13" for Blue Sea+shunt, front ~14"×10" for Nilight+Victron display). Benefits: rigid mounting surface, better screw retention, pre-assemble/wire on workbench, removable for maintenance, professional appearance. Panels secure to tote walls with bolts. Only KarlKers connectors and ventilation holes drill through HDPE.
